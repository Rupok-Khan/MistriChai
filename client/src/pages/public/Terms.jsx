        ...
        <div className="row g-3 mt-1">
          <div className="col-12 col-md-4">
            <div className="eco-card p-3 h-100">
              ...
              <div className="small-muted mt-1">Customers send the fixed ৳49 booking fee to the displayed admin bKash number and submit the transaction ID. Admin verifies it before assigning the job. Final service payment is made in cash to the partner after work completion.</div>
            </div>
          </div>
          <div className="col-12 col-md-4">
            <div className="eco-card p-3 h-100">
